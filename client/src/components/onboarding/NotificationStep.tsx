...
export function NotificationStep({ onContinue, onBack }: NotificationStepProps) {
  ...
  const handleRequestPermission = async () => {
    ...
    try {
      ...
      // ✅ Sauvegarde toujours les settings (même si refusé)
      notificationService.saveSettings(settings);

      if (granted) {
        // ✅ Planifie immédiatement les 7 prochains jours
    ...
    <div className="max-w-md w-full space-y-6 px-2">
      ...
      >
        ...
        <div
          ...
          style={{ background: '#FFF5F0', border: '1px solid #FFCBB8' }}
        >
          <div
          ...
          <div>
            <div className="flex justify-between items-center">
              <span className="font-bold text-sm" style={{ color: '#2D1A12' }}>
                💪 Motivation
              </span>
        ...
        <div className="space-y-3">
          <div className="flex justify-between items-center">
            ...
            <span
              ...
              style={{ background: '#FFE4D9', color: '#FF8C69' }}
            >
              {frequency}x
            </span>
          </div>
        ...
        <div
          ...
          style={{ border: '1px solid #FFCBB8' }}
        >
          <div
            className="p-4 flex justify-between items-center"
            style={{ borderBottom: '1px solid #FFE4D9' }}
          >
        ...
        <div
          ...
          style={{
            background: 'linear-gradient(to right, #FFF5F0, #FFF0EA)',
