...
import {
  Flame, Calendar, TrendingUp, Heart,
  ChevronLeft, ChevronRight, TrendingDown, Minus,
} from 'lucide-react';
import {
...
const MOOD_SCORES: Record<string, number> = {
  happy: 5, determined: 4, zen: 3, tired: 2, frustrated: 1,
};
const MOOD_EMOJIS: Record<string, string> = {
  happy: '😊', determined: '⚡', zen: '🍃', tired: '☁️', frustrated: '😤',
};

// Palette pêche cohérente
const P = {
  accent:   '#FF8C69',
  accentL:  '#FFA882',
  pale:     '#FFCBB8',
...
export default function Stats() {
      ...
      return (
        <div
          ...
          style={{
            ...
            boxShadow: '0 4px 16px rgba(255,140,105,0.15)',
          }}
        >
  ...
  const cardStyle = {
    ...
    border: `1px solid ${P.border}`,
    borderRadius: '1rem',
    boxShadow: `0 2px 16px rgba(255,140,105,0.08)`,
  ...
  return (
    <div
      ...
      style={{ background: `linear-gradient(160deg, ${P.bg1} 0%, ${P.bg2} 50%, ${P.bg1} 100%)` }}
    >
      {/* Header */}
      <header className="px-6 pt-10 pb-6">
        <motion.div initial={{ opacity: 0, y: -12 }} animate={{ opacity: 1, y: 0 }}>
          <h1 className="text-3xl font-display font-bold" style={{ color: P.text }}>
            {t.stats.title}
          </h1>
      ...
      <div className="px-4 space-y-4">
        ...
        >
          <div>
            <p className="text-xs font-semibold uppercase tracking-widest mb-1" style={{ color: P.textLight }}>
        ...
        >
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-1">
              ...
              <span
                className="text-xs font-medium capitalize min-w-[90px] text-center"
          ...
          {avgScore !== null && (
            <div
              ...
              style={{ background: 'rgba(255,140,105,0.08)', border: `1px solid ${P.border}` }}
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-sm font-semibold" style={{ color: P.text }}>
                  ...
                  <span className="font-normal ml-1.5 text-xs" style={{ color: P.textLight }}>
              ...
              {trend && (
                <div
                  ...
                  style={{
                    background: trend === 'better' ? 'rgba(52,211,153,0.12)'
                               : trend === 'worse'  ? 'rgba(255,140,105,0.12)'
                               :                      'rgba(176,112,96,0.10)',
                    color: trend === 'better' ? '#059669'
                         : trend === 'worse'  ? P.accent
                         :                      P.textLight,
                  }}
                >
              ...
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={currentMonthData} margin={{ top: 5, right: 5, bottom: 0, left: -20 }}>
                  ...
                  <Area
                    ...
                    fillOpacity={1}
                    fill="url(#colorScore)"
                    dot={{ fill: P.accent, strokeWidth: 0, r: 3 }}
                    activeDot={{ r: 5, fill: P.accentL }}
                  />
                </AreaChart>
              </ResponsiveContainer>
            ) : (
          ...
          >
            <p className="text-xs mb-3" style={{ color: P.textLight }}>
            ...
            <div className="flex items-center justify-between">
              {[
                ...
                <div key={item.score} className="flex flex-col items-center gap-1">
                  ...
                  <span className="text-[9px] font-bold" style={{ color: P.accent }}>
                    {item.score}/5
                  </span>
                </div>
              ))}
        ...
        {motivationMessage() && (
          <motion.div
            ...
            style={{
              background: trend === 'better' ? 'rgba(52,211,153,0.10)'
                        : trend === 'worse'  ? 'rgba(255,140,105,0.10)'
                        :                      'rgba(255,203,184,0.20)',
              border: `1px solid ${
                trend === 'better' ? 'rgba(52,211,153,0.25)'
                : trend === 'worse'  ? 'rgba(255,140,105,0.25)'
                :                      P.border
              }`,
            }}
          >
