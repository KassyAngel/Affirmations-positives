...
// Import des images avec chemins absolus depuis public
// En utilisant le préfixe spécial de Vite pour les assets publics
const getImagePath = (filename: string) => `/themes/web/mobile/${filename}`;
